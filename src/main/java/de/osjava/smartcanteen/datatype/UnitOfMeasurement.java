...
public enum UnitOfMeasurement {
	...
	GRM("GRM", "Gramm", "g"), KGM("KGM", "Kilogramm", "kg"), TON("TON",
			"Tonne", "t"), MTR("MTR", "Meter", "m"), KMR("KMR", "Kilometer",
			"km"), MLR("MLR", "Milliliter", "ml"), LTR("LTR", "Liter", "l"), STK(
			"STK", "Stueck", "stk"), EUR("EUR", "Euro", "Eur");
	...
	/**
	 * Im Standardkonstruktor werden dem Enum {@link UnitOfMeasurement}
	 * Variablen übergeben, die final gespeichert werden.
	 * 
	 * @param code
	 *            Deklaration des ENUM z.B. KGM
	 * @param name
	 *            Beschreibung des ENUM z.B. Kilogramm
	 * @param shortName
	 *            Kurzbeschreibung des ENUM z.B. kg
	 */

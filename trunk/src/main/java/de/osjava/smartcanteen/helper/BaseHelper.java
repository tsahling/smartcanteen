...
public class BaseHelper {
    ...
    public static HitListBase readHitlist(URL inputFileURL) throws IOException {
    	 ...
    	 * Loeschungen und Einfuegungen, die die interne Kapazitaet des Arrays ueberschreiten, sind dagegen relativ langsam, 
     ...
     // Die Variable mealName speichert den Namen des Gericht
        ...
        CSVInputHandler csv = new CSVInputHandler(inputFileURL, ',');
    ...
    public static ProviderBase readPriceList(URL inputFileURL, ProviderBase providerBase) throws IOException {
        ...
        // Die Variable size ist eine vom Typ Amount, die Klasse Amount ist eine Datentraegerklasse die eine Groeße repraesentiert.
        ...
        // Die Variable price ist eine vom Typ Amount, die Klasse Amount ist eine Datentraegerklasse die Groeße repraesentiert.
